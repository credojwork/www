...
class Builder_Maps_Pro {
    ...
    public function admin_enqueue() {
        ...
        wp_enqueue_script('builder-maps-pro-admin', themify_enque($this->url . 'assets/admin.js'), array(), $this->version, false);
        if(is_admin()){
            wp_enqueue_style('builder-maps-pro-admin', themify_enque($this->url . 'assets/admin.css'));
        }
        wp_localize_script('builder-maps-pro-admin', 'builderMapsPro',$this->localization());
    }
