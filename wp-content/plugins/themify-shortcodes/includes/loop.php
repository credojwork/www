 ...
 *  @var object */
global $themify;
$post_class = "post clearfix " . themify_get_categories_as_classes( get_the_id() );
...
<article id="post-<?php the_id(); ?>" <?php post_class( $post_class ); ?>>
	<?php
	if ( $post_image = themify_do_img( (int) get_post_thumbnail_id(), $themify->width, $themify->height ) ) {
