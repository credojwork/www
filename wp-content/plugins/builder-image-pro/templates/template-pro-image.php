...
$lightbox_data = $link_image_type != 'image_external' 
	&& ( ! empty( $lightbox_width ) || ! empty( $lightbox_height ) )
...
<div <?php echo $this->get_element_attributes( $container_props ); ?> data-entrance-effect="<?php echo $overlay_effect; ?>" data-exit-effect="<?php echo $out_effect[$overlay_effect]; ?>">
	...
	<div class="image-pro-wrap">
		<?php if(!empty($link_image) || 'image_modal' == $link_image_type):?>
			<a class="image-pro-external<?php if($link_image_type!='image_external'):?> themify_lightbox<?php endif;?>" href="<?php echo 'image_modal' !== $link_image_type?esc_url($link_image):'#modal-image-'.$module_ID?>" <?php if( $link_image_new_window == 'yes' ) : ?>target="_blank"<?php endif; echo $lightbox_data; ?>></a>
		<?php endif;?>
		...
		<div class="image-pro-overlay <?php echo ( 'none' == $overlay_effect ) ? 'none' : ''; ?>">
			...
			<div class="image-pro-overlay-inner">
				...
				<?php if( $action_button != '' ) : ?>
					...
					?>" <?php if( $link_new_window == 'yes' ) : ?>target="_blank"<?php endif; echo $lightbox_data; ?>>
