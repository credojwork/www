...
$jscomp.iteratorPrototype=function(b){$jscomp.initSymbolIterator();b={next:b};b[$jscomp.global.Symbol.iterator]=function(){return this};return b};$jscomp.iteratorFromArray=function(b,k){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var f=0,m={next:function(){if(f<b.length){var a=f++;return{value:k(a,b[a]),done:!1}}m.next=function(){return{done:!0,value:void 0}};return m.next()}};m[Symbol.iterator]=function(){return m};return m};
...
b(this);b('<div class="themify_builder_lite_modal"></div>').appendTo(b(this)).mouseenter(function(e){var h=0<d.children(".themify_builder_input").length,l=b(".themify_tooltip");e=b(this).offset();var g=e.top-c,h=h?50:b(this).width()/2-a;b(".themify_builder_lite_active").removeClass("themify_builder_lite_active");b(this).addClass("themify_builder_lite_active");-10>g?l.addClass("themify_tooltip_arrow_top"):l.removeClass("themify_tooltip_arrow_top");l.css({top:Math.abs(g),left:e.left+h}).delay(500).queue(function(a){var c=
...
b(k).scroll(function(){b(".themify_builder_lite_active").trigger("mouseenter")})}},Clipboard:{key:"themify_builder_clipboard_",is_available:null,storageAvailable:function(a){if(null===this.is_available)try{var b=k[a];b.setItem("__storage_test__","__storage_test__");b.removeItem("__storage_test__");this.is_available=!0}catch(d){this.is_available=!1,alert(themifyBuilder.i18n.text_no_localStorage)}return this.is_available},set:function(a,b){if(this.storageAvailable("localStorage")){var c={};c[a]=b;localStorage.setItem(this.key+
"content",JSON.stringify(c));return!0}return!1},get:function(a){if(this.storageAvailable("localStorage")){var b=JSON.parse(localStorage.getItem(this.key+"content"));return b[a]!==m?b[a]:!1}return!1}},confirmDataPaste:function(){return confirm(themifyBuilder.i18n.text_confirm_data_paste)},alertWrongPaste:function(){alert(themifyBuilder.i18n.text_alert_wrong_paste)},detectBuilderComponent:function(a){return a.data("component")||a.attr("data-component")||!1},getCheckedRadioInGroup:function(a,c){"undefined"===
typeof c&&(c=null);var d=a.attr("name");return b('input:radio[name="'+d+'"]:checked',c)},loadGoogleFonts:function(a,b){b=b||!1;var c={google:{families:a}};WebFont.load(c);b&&(c.context=b,WebFont.load(c))},autoComplete:function(a){var c=b(".themify_tax_autocomplete",a);if(0<c.length){var d=[];c.each(function(){var a=b(this),c=a.closest(".themify_builder_input").find("input.query_category_multiple"),l=c.val();b(this).autocomplete({minLength:2,source:function(c,e){var d=b.trim(c.term);b.getJSON(themifyBuilder.ajaxurl,
{term:b.trim(d),tax:a.data("tax"),action:a.data("action")},function(a,b,c){e(a)})},select:function(a,b){c.val(b.item.value);this.value=b.item.label;return!1}}).focus(function(){b(this).autocomplete("search");return!1});if(l&&"undefined"!==l){var g={};g[a.data("tax")]=l;d.push(g)}else c.val("")});0<d.length&&b.ajax({url:themifyBuilder.ajaxurl,type:"POST",dataType:"json",data:{data:d,action:"themify_builder_get_tax_data"},success:function(c){if(c)for(var e in c)b("#themify_search_cat_"+c[e].tax,a).val(c[e].val)}})}},
...
b(this).data("value");d&&-1===b.inArray(d,e.loaded_fonts)&&"webfont"!==a.find('option[value="'+d+'"]').data("type")&&WebFont.load({classes:!1,google:{families:[d]},fontloading:function(a,b){e.loaded_fonts.push(d)},fontinactive:function(a,b){e.loaded_fonts.push(d)}})}).trigger("focusin");b(".themify-combo-item",c).unbind("hover").hover(function(){var f=b(this).data("value");if(f&&b(this).is(":visible")){var g=c.next(".themify_builder_font_preview");"default"===f&&(f="inherit");g.css({top:b(this).position().top+
30,"font-family":f,display:"block"});if("inherit"!==f&&!b(this).hasClass("themify_builder_font_loaded")){var h=b(this),l=h.index();h.addClass("themify_builder_font_loaded");g=g.children("span");-1===b.inArray(f,e.fonts)&&(g.addClass("themify_show_wait"),"webfont"!==a.find('option[value="'+f+'"]').data("type")?WebFont.load({classes:!1,context:k.top,google:{families:[f]},fontloading:function(a,b){e.fonts.push(f);g.removeClass("themify_show_wait")},fontinactive:function(a,b){e.fonts.push(f);g.removeClass("themify_show_wait")}}):
(e.fonts.push(f),g.removeClass("themify_show_wait")));d(l,f,g)}}})}function d(a,c){b(".themify-combo-dropdown",top_iframe).find("li:eq("+a+")").addClass("themify_builder_font_loaded").css("font-family",c)}var e=ThemifyBuilderCommon;setTimeout(function(){e.autoComplete(a)},1);var h="",l="";if(0===Object.keys(e.safe_fonts).length){for(var g=themifyBuilder.fonts.safe,f=0,m=g.length;f<m;++f)""!==g[f].value&&"default"!==g[f].value&&(e.safe_fonts[g[f].value]=g[f].name);g=themifyBuilder.fonts.google;f=0;
for(m=g.length;f<m;++f)""!==g[f].value&&"default"!==g[f].value&&(e.google_fonts[g[f].value]=g[f].name);delete themifyBuilder.fonts}a.find(".font-family-select").each(function(){var a=b(this).data("selected"),d=b(this).find("optgroup");b(this).parent(".themify_builder_font_preview_wrapper").focusin(function(){b(this).unbind("focusin");if(!h){for(var f in e.safe_fonts){var g=a===f?'selected="selected"':"";h+="<option "+g+' data-type="webfont" value="'+f+'">'+e.safe_fonts[f]+"</option>"}for(f in e.google_fonts)g=
a===f?'selected="selected"':"",l+="<option "+g+' value="'+f+'">'+e.google_fonts[f]+"</option>"}d[0].insertAdjacentHTML("beforeend",h);d.last()[0].insertAdjacentHTML("beforeend",l);c(b(this).children("select"))});a&&(e.safe_fonts[a]?d[0].insertAdjacentHTML("beforeend",'<option selected="selected" data-type="webfont" value="'+a+'">'+e.safe_fonts[a]+"</option>"):e.google_fonts[a]&&d.last()[0].insertAdjacentHTML("beforeend",'<option selected="selected" value="'+a+'">'+e.google_fonts[a]+"</option>"))});
if(0<e.fonts.length){var g=b(".themify-combo-dropdown").first(),n;for(n in e.fonts)f=g.find('[data-value="'+e.fonts[n]+'"]').index(),d(f,e.fonts[n])}b(".themify-combo-arrow",top_iframe).unbind("click").click(function(){b(".themify_builder_font_preview",top_iframe).hide()})},Lightbox:{$lightbox:null,rememberedRow:null,rememberedCid:null,setup:function(){var a="true"===themifyBuilder.isThemifyTheme?"is-themify-theme":"is-not-themify-theme",a=wp.template("builder_lightbox")({is_themify_theme:a});top_iframe.body.insertAdjacentHTML("beforeend",
...
a.clickCheckboxOption).on("change",".border_style",a.hideShowBorder).on(c,".tb-icon-radio label",a.bindStylingToggles).on(c,".tb-style-toggle",a.bindStylingRows).on("change","#tb_module_settings .query_category_single",function(){b(this).closest(".themify_builder_input").find(".query_category_multiple").val(b(this).val())}).one("themify_opened_lightbox",a.resizable.init.bind(a.resizable));f.body.insertAdjacentHTML("beforeend",'<div id="themify_builder_overlay"></div>');themifyBuilder.disableShortcuts||
a.controlByKeyInput();if("visual"===themifybuilderapp.mode)a.$lightbox.on(c,".builder_cancel_docked_mode",function(c){c.preventDefault();c.stopPropagation();a.dockMode.close(!0);b(f).trigger("mouseup")})},adjustHeight:function(a){this.$lightbox.find("#themify_builder_lightbox_container").css("height",a-55)},getLightboxStorageKey:function(){return"visual"===themifybuilderapp.mode?"themify_builder_lightbox_frontend_pos_size":"themify_builder_lightbox_backend_pos_size"},getLightboxStorage:function(){var a=
localStorage.getItem(this.getLightboxStorageKey());return a&&JSON.parse(a)},resizable:{$el:"",w:"",h:"",x:"",y:"",axis:"",overlay:!1,minWidth:500,maxWidth:880,minHeight:320,maxHeight:800,init:function(){var a=this,c=ThemifyBuilderCommon.Lightbox,d=b("body",top_iframe),e=function(e,h){if(h!==m&&e&&e.target.classList.contains("builder-lightbox"))switch(e.type){case "dragstart":d.addClass("themify_lightbox_drag");c.fixContainment();break;case "dragstop":d.removeClass("themify_lightbox_drag"),c.fixContainment(),
"visual"===themifybuilderapp.mode&&b(f).trigger("mouseup"),a.remember();case "drag":c.dockMode.drag(e)}};this.$el=c.$lightbox;a.$el.draggable({handle:a.$el.find(".themify_builder_lightbox_top_bar"),scroll:!1,start:e,drag:e,stop:e});"visual"===themifybuilderapp.mode&&(this.tb_resizable_overlay=this.$el.prev(".tb_resizable_overlay"));for(var e=this.$el[0].getElementsByClassName("tb_resizable"),h=0,l=e.length;h<l;++h)e[h].addEventListener("mousedown",function(c){1===c.which&&(c.preventDefault(),a.x=
c.clientX,a.y=c.clientY,a.w=parseInt(a.$el.outerWidth(),10),a.h=parseInt(a.$el.outerHeight(),10),a.axis=this.classList.contains("tb_resizable-se")?"both":this.classList.contains("tb_resizable-s")?"y":this.classList.contains("tb_resizable-w")?"w":"x",a.tb_resizable_overlay&&a.tb_resizable_overlay.show(),a.$el.addClass("tb_resizing"),top_iframe.addEventListener("mousemove",a.resize,!1),top_iframe.addEventListener("mouseup",a.stop,!1),"w"===a.axis&&(d.addClass("tb_start_animate"),b("body").addClass("tb_start_animate")))},
!1);b("body").on("editing_module_option",a.setupLightboxSizeClass)},remember:function(){var a=ThemifyBuilderCommon.Lightbox.resizable,b=a.$el.position(),d=ThemifyBuilderCommon.Lightbox.dockMode.get(),e=ThemifyBuilderCommon.Lightbox.getLightboxStorage(),a={top:b.top,left:b.left,width:d&&e?e.width:a.$el.outerWidth(),height:d&&e?e.height:a.$el.outerHeight()};localStorage.setItem(ThemifyBuilderCommon.Lightbox.getLightboxStorageKey(),JSON.stringify(a))},setupLightboxSizeClass:function(){var a=ThemifyBuilderCommon.Lightbox.resizable;
a.$el.toggleClass("larger-lightbox",750<parseInt(a.$el.width()))},resize:function(a){var b=ThemifyBuilderCommon.Lightbox.resizable,d=b.w+a.clientX-b.x,e=b.h+a.clientY-b.y;"w"===b.axis?(d=b.x+b.w-a.clientX,300<=d&&d<=b.maxWidth&&(b.$el.width(d),b.setupLightboxSizeClass(),ThemifyBuilderCommon.Lightbox.dockMode.resize(a))):(("both"===b.axis||"x"===b.axis)&&d>=b.minWidth&&d<=b.maxWidth&&(b.$el.width(d),b.setupLightboxSizeClass()),("both"===b.axis||"y"===b.axis)&&e>=b.minHeight&&e<=b.maxHeight&&(b.$el.height(e),
ThemifyBuilderCommon.Lightbox.adjustHeight(b.$el.height())))},stop:function(a){a=ThemifyBuilderCommon.Lightbox;var c=a.resizable;c.tb_resizable_overlay&&c.tb_resizable_overlay.hide();c.$el.removeClass("tb_resizing");top_iframe.removeEventListener("mousemove",c.resize,!1);top_iframe.removeEventListener("mouseup",c.stop,!1);a.fixContainment();c.remember();a.dockMode.resize("stop");b("body").trigger("themify_builder_lightbox_resize");"w"===c.axis&&(a=b("body",top_iframe),a=a.add("body"),a.removeClass("tb_start_animate"))}},
fixContainment:function(){var a=ThemifyBuilderCommon.Lightbox,c=a.$lightbox.outerWidth(),d=b(k.top).width(),e=b(k.top).height(),c=[-c+20,0,d-20,e-30],d=a.$lightbox.position(),e={};d.left<c[0]&&(e.left=c[0]);0>d.top&&(e.top=0);d.left>c[2]&&(e.left=c[2]);d.top>c[3]&&(e.top=c[3]);a.$lightbox.css(e)},open:function(a,c,d){var e=ThemifyBuilderCommon.Lightbox,f=b("#themify_builder_lightbox_container",e.$lightbox);themifybuilderapp.toolbar.Panel.hide();b("#themify_builder_overlay").show();ThemifyBuilderCommon.showLoader("show");
"inline"===a.loadMethod?(a=ThemifyBuilderCommon.templateCache.get("tmpl-"+a.templateID),e.openCallback(a,f,c,d)):"html"===a.loadMethod?e.openCallback(a.data,f,c,d):(a.data=_.extend(a.data||{},{nonce:themifyBuilder.tb_load_nonce}),a=_.defaults(a||{},{type:"POST",url:themifyBuilder.ajaxurl}),b.ajax(a).done(function(a){e.openCallback(a,f,c,d);a=b(f).find(".themify_builder_options_tab_wrapper");0<a.length&&new SimpleBar(a[0])}))},openCallback:function(a,c,d,e){themifybuilderapp.toolbar.undoManager.disable();
var h=ThemifyBuilderCommon.Lightbox,l=h.getLightboxStorage(),g={top:100,left:0,width:600,height:500};null!==l?g=l:g.left=Math.max(0,b(k.top).width()/2-300);a=b(a);l=a.find("#themify_builder_lightbox_options_tab_items");0<l.length&&(h.$lightbox[0].getElementsByClassName("themify_builder_options_tab")[0].insertAdjacentHTML("beforeend",l[0].innerHTML),l.remove());l=a.find("#themify_builder_lightbox_actions_items");0<l.length&&(h.$lightbox[0].getElementsByClassName("themify_builder_lightbox_actions")[0].insertAdjacentHTML("beforeend",
l[0].innerHTML),l.remove());"function"===typeof d&&d.call(h,a[0]);c.html(a[0]);"function"===typeof e&&e.call(h,a[0]);h.$lightbox.addClass("themify_builder_show_start").show().css(g);h.dockMode.setDoc();h.fixContainment();ThemifyBuilderCommon.showLoader("spinhide");if(!themifyBuilder.disableShortcuts)b(f).off("keyup",h.cancelKeyListener).on("keyup",h.cancelKeyListener);h.adjustHeight(g.height);ThemifyBuilderCommon.setUpTooltip();h.$lightbox.removeClass("themify_builder_show_start").trigger("themify_opened_lightbox")},
close:function(){var a=ThemifyBuilderCommon.Lightbox;b("body").trigger("themify_builder_lightbox_before_close");a.$lightbox.fadeOut(function(c){b(this).removeClass("animated fadeOut");a._cleanLightBoxContent();b("#themify_builder_overlay").hide();b("#themify_builder_lightbox_parent",top_iframe).hide();themifybuilderapp.toolbar.Panel.resetPanel();themifybuilderapp.activeModel&&(themifybuilderapp.activeModel.unset("styleClicked",{silent:!0}),themifybuilderapp.activeModel.unset("visibileClicked",{silent:!0}));
themifybuilderapp.toolbar.undoManager.updateUndoBtns();b("body").trigger("themify_builder_lightbox_close");a.dockMode.close(!1,!0)})},dockMode:{key:"themify_builder_docked",workspace:b(".themify_builder_workspace_container",top_iframe.body),isDocked:null,defaultWidth:380,dockOut:0,checkIsVisual:function(){return"visual"===themifybuilderapp.mode},set:function(a,b){!b&&localStorage.setItem(this.key,a);this.isDocked=a},get:function(){return this.isDocked||"true"===localStorage.getItem(this.key)},setStyleRowToggle:function(){var a=
ThemifyBuilderCommon.Lightbox,b=a.$lightbox.find(".tb-style-toggle"),a=a.$lightbox.find("#themify_builder_options_styling .themify_builder_field");b.addClass("tb-closed");a.addClass("tb-field-expanded")},setDoc:function(){this.checkIsVisual()&&this.get()&&(top_iframe.body.classList.add("tb_module_panel_docked"),ThemifyBuilderCommon.Lightbox.$lightbox.css("width",this.defaultWidth),this.setWidth(),this.onResize(),b(k.top).off("tfsmartresize.docked").on("tfsmartresize.docked",function(){this.resize();
this.onResize()}.bind(this)),b("body").off("themify_builder_change_mode.docked").on("themify_builder_change_mode.docked",function(a,b,d){this.setWidth();"desktop"!==d&&"desktop"===b&&setTimeout(function(){themifybuilderapp.toolbar.$el.width()!==top_iframe.documentElement.clientWidth&&(this.setWidth(),this.onResize())}.bind(this),500)}.bind(this)));this.setStyleRowToggle()},setWidth:function(){var a=(top_iframe.documentElement.clientWidth||top_iframe.body.clientWidth)-ThemifyBuilderCommon.Lightbox.$lightbox.css("height",
"").width();themifybuilderapp.toolbar.$el.css("width",a);this.workspace.css("width",a)},resize:function(a){this.checkIsVisual()&&this.get()&&(this.setWidth(),"stop"===a&&this.onResize())},onResize:function(){themifybuilderapp.Utils._onResize(!0)},drag:function(a){this.checkIsVisual()&&((top_iframe.body.classList.toggle("themify-dock-highlight","drag"===a.type&&a.pageX+20>=k.top.innerWidth),a.pageX+20>=k.top.innerWidth&&"dragstop"===a.type)?(this.set(!0),this.setDoc()):this.get()&&(this.dockOut?this.dockOut&&
"dragstop"===a.type?this.dockOut=0:50<this.dockOut-a.clientX&&(this.close(),this.dockOut=0,b(f).trigger("mouseup")):this.dockOut=a.clientX))},close:function(a,c){if(this.checkIsVisual()&&this.get()){var d=ThemifyBuilderCommon.Lightbox,e=d.getLightboxStorage(),e={height:e.height?e.height:d.rsesizable.minHeight};a&&(e.top=k.top.innerHeight/2-d.$lightbox.innerHeight()/2,e.left=k.top.innerWidth/2-d.$lightbox.innerWidth()/2);d.$lightbox.width()<d.resizable.minWidth&&(e.width=d.resizable.minWidth);d.$lightbox.css(e);
this.set(!1,c);d.resizable.remember();top_iframe.body.classList.remove("tb_module_panel_docked");themifybuilderapp.toolbar.$el.css("width","");this.workspace.css("width","");this.onResize();b(k.top).off("tfsmartresize.docked");b("body").off("themify_builder_change_mode.docked")}}},_cleanLightBoxContent:function(){this.forgetRow();this.$lightbox.find(".themify_builder_options_tab").empty();this.$lightbox.find(".themify_builder_lightbox_actions").children().not(".builder_cancel_lightbox, .builder_cancel_docked_mode").remove()},
controlByKeyInput:function(){function a(a){83!==a.which||"INPUT"===f.activeElement.tagName||"TEXTAREA"===f.activeElement.tagName||!0!==a.ctrlKey&&!0!==a.metaKey||(a.preventDefault(),a.stopPropagation(),a=b(".builder_save_button",top_iframe),0<a.length?a.trigger("click"):themifybuilderapp.toolbar.$el.find(".tb_toolbar_save").trigger("click"))}b(f).on("keydown",a);if("visual"===themifybuilderapp.mode)b(top_iframe).on("keydown",a)},clone:function(a){a=a.clone(!0);"visual"===themifybuilderapp.mode&&(a.find("video").trigger("pause"),
a.find(".big-video-wrap").remove());return a},rememberRow:function(){this.rememberedRow=this.clone(b(".tb_element_cid_"+themifybuilderapp.activeModel.cid));this.rememberedCid=themifybuilderapp.activeModel.cid},revertToRememberedRow:function(){var a=themifybuilderapp.Models.Registry.lookup(this.rememberedCid);if(a){var b=a.get("elType");"subrow"!==b&&"column"!==b&&a.trigger("custom:restorehtml",this.rememberedRow)}this.forgetRow()},forgetRow:function(){this.rememberedRow=this.rememberedCid=null},clickRadioOption:function(a,
...
c.prop("checked",!1).trigger("change"))},bindStylingRows:function(a){a.preventDefault();a=b(this).nextUntil(".tb-style-toggle");this.classList.contains("tb-closed")?(this.classList.remove("tb-closed"),a.removeClass("tb-field-expanded")):(this.classList.add("tb-closed"),a.addClass("tb-field-expanded"))},hideShowBorder:function(a,c){if(!a||!a.isTrigger){c||(c=b(this));var d=c.closest(".selectwrapper").siblings(".tb_border_wrapper");"none"===c.val()?d.hide():d.show()}},cancelKeyListener:function(a){var b=
