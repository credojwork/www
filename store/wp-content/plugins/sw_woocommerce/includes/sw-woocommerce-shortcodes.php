 							...
 							<div class="item-inner">
 								<div class="item-img">
 									<a href="<?php echo get_permalink($post->ID) ?>" title="<?php echo esc_attr( $post->post_title ) ?>">
 										...
 										<?php echo ( get_the_post_thumbnail( $r->post->ID, 'thumbnail_seller' ) ) ? get_the_post_thumbnail( $r->post->ID, 'thumbnail_seller' ):'<img src="'.get_template_directory_uri().'/assets/img/placeholder/shop_thumbnail.png" alt="No thumb"/>';
 									}else{ ?>
