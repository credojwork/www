	...
	<div class="resp-tab" style="position:relative;">				
		...
		<div class="wrap-top">
			...
			<?php if( $icon != '' ):
				...
				<h3><span><?php echo $ic; ?></span><?php echo ( $title1 != '' ) ? $title1 : $term_name ; ?></h3>
			</div>
		<?php 							
		...
		<!-- End get child category -->		
			<div class="tab-content clearfix">		
				...
				<div class="categories-image clearfix">
					<div class="item-image">			 
						<a href="<?php echo get_term_link( $term->term_id, 'product_cat' ); ?>" title="<?php echo esc_attr( $term->name ); ?>">
							<?php if( $images !='' ) { ?>
			...
			<!-- End product tab slider -->
				...
				<div class="view-all"><a href="<?php echo esc_url( $viewall ); ?>"><?php echo esc_html__('View All','sw_woocommerce');?> <?php echo $term_name; ?><i class="fa  fa-caret-right"></i></a></div>
		</div>
	</div>
</div>