...
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo $id; ?>" class="mobile-layout-style2 style-moblie clearfix">
		<div class="block-title clearfix">
			<h3><span class="fa <?php echo esc_attr( $icon_m ); ?>"></span>
		...
		<div class="wrap-link">
			<div class="wrap-countdown">
				<div class="item-countdown countdown-style2 custom-font" data-cdtime="<?php echo esc_attr( $countdown_time ); ?>"></div>
			</div>
		</div>	
