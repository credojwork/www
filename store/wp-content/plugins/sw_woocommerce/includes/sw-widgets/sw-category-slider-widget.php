				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Theme1' => 'theme1', 'Layout Theme2' => 'theme2',  'Layout Theme3' => 'theme3',  'Layout Mobile1' => 'theme_mobile' ),
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2', 'layout2','theme3','theme4' )
					),
				 ),
			  )
		   ) );
		...
		**/
		...
		function sw_category_ajax_listing(){
			...
			if( $term ) :
				...
				$thumb1 = wp_get_attachment_image( $thumbnail_id1,'onemall_cat_thumb_mobile' );
