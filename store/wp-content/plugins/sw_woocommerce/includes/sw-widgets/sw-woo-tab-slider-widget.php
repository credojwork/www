...
if ( !class_exists('sw_woo_tab_slider_widget') ) {
	class sw_woo_tab_slider_widget extends WP_Widget {
		...
		function SC_integrateWithVC(){
			...
			vc_map( array(
				...
				array(
				 ...
				 array(
					'type' => 'attach_images',
					'heading' => __( 'Icon Slide', 'sw_woocommerce' ),
					'param_name' => 'icon',
				 ...
				 array(
					...
					"param_name" => "style",
					"admin_label" => true,
					"value" => array( 'Default' => '', 'Style 1' => 'style1', 'Style 2' => 'style2', 'Style 3' => 'style3'),
				 ...
				 array(
				  ...
				  array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Number row per column Layout 1", 'sw_woocommerce' ),
		...
		**/
		...
		function sw_tab_category_callback(){
			...
			$item_row2    = ( isset( $_POST["item_row2"] )  && $_POST["item_row2"] > 0 ) ? $_POST["item_row2"] : 5;
	...
	<?php 
		...
		?>
			...
			<div id="<?php echo esc_attr( 'tab_'. $target ); ?>" class="woo-tab-container-listing clearfix">
				<!-- get 5 product first -->
				...
				<script type="text/javascript">
					(function ($) {
						...
						var $img_slider 	= $(<?php echo '"' .esc_js( '#'.'tab_'. $target . ' .product-responsive' ). '"' ?> );
						var $thumb_slider = $(<?php echo '"' .esc_js( '#'.'tab_'. $target . ' .product-responsive-thumbnail' ). '"' ?> );
						$img_slider.slick({
							slidesToShow: 1,
							slidesToScroll: 1,
							fade: true,
