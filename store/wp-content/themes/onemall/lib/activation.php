...
function sw_activation_options_add_page() {
	...
	if ($sw_activation_options['first_run']) {
		$theme_page = add_theme_page(
				esc_html__('Theme Activation', 'onemall'),
				esc_html__('Theme Activation', 'onemall'),
				'edit_theme_options',
				'sw_activation_options',
...
<div class="sw-activation-form">
	<div class="activation-form-inner">
		<h2>
			<?php printf( esc_html__( '%s Theme Activation', 'onemall' ), wp_get_theme() ); ?>
		</h2>
		<?php settings_errors(); ?>
					...
					<li>
						<label for="update_theme" class="clearfix">
							...
							<div class="activation-content">
								<h3><?php esc_html_e( 'New Installation (Install theme with demo data)', 'onemall' ); ?></h3>
								<div class="activation-desc"><?php esc_html_e( 'Install your theme with our sample data.
	Use our sample data for all files, products, images, configurations... that you will have a complete website that is exactly same as our Demo.', 'onemall' ); ?></div>
							</div>
						</label>
					</li>
					<li>
						<label for="upgrade_theme" class="clearfix">
							...
							<div class="activation-content">
								<h3><?php esc_html_e( 'Upgrade Theme (Install theme only)', 'onemall' ); ?></h3>
								<div class="activation-desc"><?php esc_html_e( "Install your theme with your data.
	Your files, products, images, configurations... aren't change. You will get the Onemall theme layouts and pages.", 'onemall' ); ?></div>
							</div>
						</label>
					</li>
				</ul>
