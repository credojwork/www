...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('category') ); ?>"><?php esc_html_e('Category Name', 'onemall')?></label>
	<br />
	<?php echo $this->category_select('category', array('allow_select_all' => true), $categoryid); ?>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('orderby') ); ?>"><?php esc_html_e('Orderby', 'onemall')?></label>
	<br />
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('order') ); ?>"><?php esc_html_e('Order', 'onemall')?></label>
	<br />
	<select class="widefat"
		...
		<?php } ?>>
			<?php esc_html_e('Descending', 'onemall')?>
		</option>
		<option value="ASC" <?php if ($order=='ASC'){?> selected="selected"
		<?php } ?>>
			<?php esc_html_e('Ascending', 'onemall')?>
		</option>
	</select>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('numberposts') ); ?>"><?php esc_html_e('Number of Posts', 'onemall')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('include') ); ?>"><?php esc_html_e('Include Posts ID', 'onemall')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('exclude') ); ?>"><?php esc_html_e('Exclude Posts ID', 'onemall')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('length') ); ?>"><?php esc_html_e('Excerpt length (in words): ', 'onemall')?></label>
	<br />
	<input class="widefat"
