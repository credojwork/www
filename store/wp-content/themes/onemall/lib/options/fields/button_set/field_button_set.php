<?php
class Onemall_Options_button_set extends Onemall_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('onemall-opts-jquery-ui-css');

		wp_enqueue_script(
			'onemall-opts-field-button_set-js', 
			ONEMALL_OPTIONS_URL.'fields/button_set/field_button_set.js', 
