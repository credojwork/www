				...
				<div class="content-top">
					...
					<div class="entry-meta">
						...
						<span class="entry-comment">
							<a href="<?php comments_link(); ?>"><i class="fa fa-comments"></i><?php echo $post-> comment_count .  ( ($post-> comment_count) > 1 ? esc_html__('  Comments', 'onemall') : esc_html__('  Comment', 'onemall')); ?></a>
						</span>
					</div>
				</div>
				<div class="readmore"><a href="<?php echo get_permalink($post->ID)?>"><i class="fa fa-caret-right"></i><?php esc_html_e('Read More', 'onemall'); ?></a></div>
			</div>
		<?php } elseif( !$format == ''){?>
