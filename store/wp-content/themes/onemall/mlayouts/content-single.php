		...
		<?php if( $pfm == '' || $pfm == 'image' ){?>
			<?php if( has_post_thumbnail() ){ ?>
				<div class="entry-thumb single-thumb">
						<?php the_post_thumbnail('onemall_blog_mobile');?>						
				</div>
			<?php }?>
		<?php } ?>
		<div class="entry-content clearfix">
			<div class="entry-meta clearfix">
				<span class="entry-author">
					<i class="fa fa-user"></i><?php esc_html_e('Post By:', 'onemall'); ?> <?php the_author_posts_link(); ?>
				</span>
				<div class="entry-comment">
					<a href="<?php comments_link(); ?>">
						<i class="fa fa-comments-o"></i>
						<?php echo $post->comment_count . ( ( $post->comment_count > 1 ) ? esc_html__(' Comments ', 'onemall') : esc_html__(' Comment ', 'onemall') ); ?>
					</a>
				</div>
			</div>
  ...
  <?php 
	...
	?>
			<div class="single-post-relate-mobile">
				<h4><?php esc_html_e('Related News', 'onemall'); ?></h4>
				<?php
				...
				?>
					<div <?php post_class( $class_col ); ?> >
						...
						<div class="item-relate-img">
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('onemall_related_mobile'); ?></a>
						</div>
						<?php } ?>
