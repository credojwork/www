		...
		<div class="entry-content">				
			<div class="content-top">
				...
				<div class="entry-title">
					<h4><a href="<?php echo get_permalink($post->ID)?>"><?php onemall_trim_words( $post->post_title );?></a></h4>
				</div>
				...
				<div class="entry-meta">
					<span class="entry-author">
						<?php esc_html_e('Post By', 'onemall'); ?> <?php the_author_posts_link(); ?>
					</span>
					<span class="entry-comment">
						<a href="<?php comments_link(); ?>"><?php echo $post-> comment_count .  esc_html__('  Comment(s)', 'onemall'); ?></a>
					</span>
				</div>
			</div>
		</div>
