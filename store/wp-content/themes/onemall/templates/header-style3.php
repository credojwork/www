<?php
	...
	*/
	...
	$onemall_menu_item 	= ( onemall_options()->getCpanelValue( 'menu_number_item' ) )  ? onemall_options()->getCpanelValue( 'menu_number_item' )  : 10;
	$onemall_mmenu_item	= ( onemall_options()->getCpanelValue( 'mmenu_number_item' ) ) ? onemall_options()->getCpanelValue( 'mmenu_number_item' ) : 10;
...
<header id="header" class="header header-<?php echo esc_attr( $onemall_page_header );?>">
	...
	<div class="header-socials">
		<?php if (is_active_sidebar('bottom-right2')) {?>
			<?php dynamic_sidebar('bottom-right2'); ?>
		<?php }?>
	</div>
</header>