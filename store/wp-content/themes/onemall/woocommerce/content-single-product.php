...
<div class="container">
	<div class="row sidebar-row">
		<?php if ( is_active_sidebar('left-product-detail') && onemall_sidebar_product() == 'left' ):
		...
		<div id="contents-detail" <?php onemall_content_product_detail(); ?> role="main">
			<?php
				/**
		...
		<?php if ( is_active_sidebar('right-product-detail') && onemall_sidebar_product() == 'right' ):
