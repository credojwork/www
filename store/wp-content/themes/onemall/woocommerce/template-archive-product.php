...
<div class="container">
	...
	<?php 
		if ( is_active_sidebar('left-product') && onemall_sidebar_product() != 'right' && onemall_sidebar_product() != 'full' ):
	...
	<div id="contents" <?php onemall_content_product(); ?> role="main">
		<?php
			/**
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php 					
					...
					if( sw_woocommerce_version_check( '3.3' ) ){
						echo apply_filters( 'onemall_custom_category', $html = '' );
					}else{
	...
	<?php if ( is_active_sidebar('right-product') && onemall_sidebar_product() != 'left' && onemall_sidebar_product() != 'full' ):
