...
global $woocommerce; ?>
<div class="top-form top-form-minicart onemall-minicart3 pull-right">
	<div class="top-minicart-icon pull-right">
		<i class="fa fa-shopping-cart"></i>
		<div class="title-cart">
			<h3><?php esc_html_e('My Cart', 'onemall'); ?></h3>
			<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'onemall'); ?>"><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>';  esc_html_e(' item(s)', 'onemall');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?></a>
		</div>
	</div>
