...
?>
<div id="product_img_<?php echo esc_attr( $post->ID ); ?>" class="woocommerce-product-gallery woocommerce-product-gallery--with-images images product-images loading" data-vertical="<?php echo ( $onemall_single_thunbmail == 'left' || $onemall_single_thunbmail == 'right' ) ? 'true' : 'false'; ?>" data-video="<?php echo ( $onemall_featured_video != '' ) ?  esc_url( 'https://www.youtube.com/embed/' . $onemall_featured_video ) : ''; ?>">
	<figure class="woocommerce-product-gallery__wrapper">
	<div class="product-images-container clearfix <?php echo esc_attr( 'thumbnail-' . $onemall_single_thunbmail ); ?>">
		<?php 
