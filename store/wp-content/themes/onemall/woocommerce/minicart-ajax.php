...
global $woocommerce; ?>
<div class="top-form top-form-minicart onemall-minicart pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'onemall'); ?>"></a>
		<div class="cart-right">
			<h3><?php esc_html_e('Shopping Cart','onemall');?></h3>
			<p><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count. esc_html_e(' Item(s) ','onemall'). '</span>';?></p>
		</div>
	</div>
				...
				?>
					<li>
						<a href="<?php echo get_permalink($cart_item['product_id']); ?>" class="product-image">
							<?php echo $_product->get_image( array(80,80)); ?>
						</a>
						...
						<div class="detail-item">
							<div class="product-details"> 
								...
								<div class="product-price">
									<span class="price"><?php echo $woocommerce->cart->get_product_subtotal($cart_item['data'], 1); ?> x </span>	      
									<div class="qty">
										<?php echo '<span class="qty-number">'.esc_html( $cart_item['quantity'] ).'</span>'; ?>
									</div>
								</div>
								<div class="product-action clearfix">
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-remove" title="%s"><span class="fa fa-times"></span></a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'onemall' ) ), $cart_item_key ); ?>           
